...
const rebuildUrls = require('../ci/_rebuildUrls');

/**
 * @function rebuildStorefrontUrls
 * @description This function is used to trigger the re-building of a storefront urls.
 *
 * @param [processCallback] {Function} Represents the callback function to execute one the url-rebuild is triggered
 */
function reIndexStorefront(processCallback) {
    ...
    console.log('-----------------------------------');
    console.log(' SFCC-CI | START: npm rebuild-urls');
    console.log('-----------------------------------');
    ...
    async.waterfall([
        ...
        function reIndex(environmentToken, asyncCallback) {
            ...
            rebuildUrls(environment, environmentToken, function (jobDetails) {

                // Were job-details specified?
                if (jobDetails !== null) {

                    // Debugging: Output that the remote-index rebuild was processed successfully
                    console.log(` ${environment.instanceName}| -- the storefront urls were successfully rebuilt`);
        ...
        console.log('-----------------------------------');
        console.log(' SFCC-CI |  END: npm rebuild-urls');
        console.log('-----------------------------------');
